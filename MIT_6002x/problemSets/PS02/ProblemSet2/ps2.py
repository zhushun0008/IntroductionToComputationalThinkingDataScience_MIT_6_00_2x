...
class RectangularRoom(object):
    ...
    def isPositionInRoom(self, pos):
        ...
        """
        return math.floor(pos.getX()) in range(self.width) and math.floor(pos.getY()) in range(self.height)
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        initPosition = room.getRandomPosition()
        while not room.isPositionInRoom(initPosition):
            initPosition = self.room.getRandomPosition()

        self.position = initPosition
        self.direction = math.floor(360 * random.random())
...
#       (... your call here ...)
#
##showPlot2('Time It Takes Two Robots To Clean 80% Of Variously Shaped Rooms', 'Aspect Ratios', 'Time-steps')